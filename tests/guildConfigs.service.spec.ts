...
describe('[Service] ServerConfigs', () => {
  describe('getServerConfigs()', () => {
    ...
    it('two', async () => {
      ...
      mockedAxios.get.mockResolvedValue({ data: { results: [constantMocks.serverConfig, constantMocks.serverConfig] } });
      const result = await GuildConfigsService.getGuildConfigs();
  ...
  describe('putServerConfig()', () => {
    it('valid', async () => {
      ...
      const result = await GuildConfigsService.putGuildConfig(constantMocks.serverConfig.guild_id, constantMocks.serverConfig.guild_id, 'enEN', 'Europe/Paris');
  ...
  describe('postServerConfig()', () => {
    it('valid', async () => {
      ...
      const result = await GuildConfigsService.postGuildConfig(constantMocks.serverConfig.guild_id, constantMocks.serverConfig.guild_id, 'enEN', 'Europe/Paris');
      expect(result).not.toBeNull();
    });
    it('error', async () => {
      expect.assertions(1);
